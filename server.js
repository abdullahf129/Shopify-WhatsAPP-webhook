...
app.post('/', async (req, res) => {
  ...
  if (hash === hmac) {
    ...
    try {
      ...
      const phoneNumber1 = bodyObject.customer.phone || bodyObject.billing_address && bodyObject.billing_address.phone; ; // Assuming 'phone' is the key for the phone number
        ...
        console.log('Phone number:', bodyObject.billing_address.phone);
